...
package edu.sfsu.cs.orange.ocr2;
...
import com.ocr.contact.GetContactdetails;

import com.ocr.contact.Hashconctact;
...
import edu.sfsu.cs.orange.ocr2.Contactpojo;
...
Contactpojo contact=new Contactpojo();
  ...
  private static final int SAVE_NAME = Menu.FIRST + 4;
  private static final int SAVE_NUMBER = Menu.FIRST + 5;
  ...
  public void onCreateContextMenu(ContextMenu menu, View v,
    ...
    if (v.equals(ocrResultView)) {
      ...
      menu.add(Menu.NONE, SAVE_NAME, Menu.NONE, "Search in google");
      menu.add(Menu.NONE, SAVE_NUMBER, Menu.NONE, "Standard Cards");
      menu.add(Menu.NONE, SAVE, Menu.NONE, "unknow card");
  ...
  public boolean onContextItemSelected(MenuItem item) {
    ...
    case SAVE_NAME:
    	contact.setMobile((String) ocrResultView.getText());
     	 ArrayList<String> ars= new ArrayList<String>();
     	 String url= "https://www.google.co.in/?gws_rd=ssl#q="+ocrResultView.getText().toString();
    ...
    case SAVE_NUMBER:
    	...
    	contact.setMobile((String) ocrResultView.getText());
      	 ...
      	 ar.add(ocrResultView.getText().toString());
        Intent i = new Intent(this,Hashconctact.class);
        i.putExtra("Result", ar);
        startActivity(i);
        return true;
    ...
    case SAVE:
   	 ...
   	 ar1.add(ocrResultView.getText().toString());
       Intent i11 = new Intent(this,GetContactdetails.class);
       i11.putExtra("Result", ar1);
       startActivity(i11);
       return true;
    default:
